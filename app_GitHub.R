...
# Access token for Mapbox, and Google Maps API Key
mapbox_token <- Sys.getenv("MAPBOX_API_KEY")
...
ui <- fluidPage(
  ...
  tags$head(
    ...
    tags$script(src = paste0("https://maps.googleapis.com/maps/api/js?key=",googleMapsKey))
  ),
